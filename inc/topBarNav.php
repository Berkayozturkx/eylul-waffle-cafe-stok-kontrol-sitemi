            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link" aria-current="page" href="./">Ana sayfa</a></li>
                        <?php if(isset($_SESSION['userdata']['id']) && $_settings->userdata('type') == 2): ?>

                        <li class="nav-item"><a class="nav-link" href="./?page=my_transactions">İşlemlerim</a></li>
                        <?php endif; ?>
                        <li class="nav-item"><a class="nav-link" href="./?page=about_us">Hakkımızda</a></li>
                    </ul>
                    <div class="navbar-nav ml-auto d-flex align-items-center">
                      <?php if(isset($_SESSION['userdata']['id']) && $_settings->userdata('type') == 2): ?>
                        ...
                        <?php else: ?>
                        <a class="btn btn-dark text-light ml-2" id="login-btn" href="./login.php">Giriş Yap</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
