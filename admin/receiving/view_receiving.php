...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Teslim Alınan Sipariş Detayları - <?php echo $po_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">Satın Alınan Sipariş Kodu</label>
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tfoot>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">Ara Toplam</th>
                        <th class="text-right py-1 px-2 sub-total"><?php echo number_format($total,2)  ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">İndirim <?php echo isset($discount_perc) ? $discount_perc : 0 ?>%</th>
                        <th class="text-right py-1 px-2 discount"><?php echo isset($discount) ? number_format($discount,2) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">Vergi <?php echo isset($tax_perc) ? $tax_perc : 0 ?>%</th>
            ...
            <div class="row">
                ...
                <?php if($status > 0): ?>
                <div class="col-md-6">
                    <span class="text-info"><?php echo ($status == 2)? "Alındı" : "Kısmen Alındı" ?></span>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin?page=receiving/manage_receiving&id='.(isset($id) ? $id : '') ?>">Düzenle</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=receiving' ?>">Listeye Dön</a>
    </div>
</div>
