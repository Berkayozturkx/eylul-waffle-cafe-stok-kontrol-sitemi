...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Satış Kayıtları - <?php echo $sales_code ?></h4>
    </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin?page=sales/manage_sale&id='.(isset($id) ? $id : '') ?>">Düzenle</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=sales' ?>">Listeye Dön</a>
    </div>
</div>
