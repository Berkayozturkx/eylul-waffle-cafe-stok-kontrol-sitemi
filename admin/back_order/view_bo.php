...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Bekleyen Sipariş Detayları - <?php echo $bo_code ?></h4>
    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <p><?php echo isset($remarks) ? $remarks : 'Yok' ?></p>
                    </div>
                </div>
                <?php if($status > 0): ?>
                <div class="col-md-6">
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=back_order' ?>">Listeye Dön</a>
    </div>
</div>
