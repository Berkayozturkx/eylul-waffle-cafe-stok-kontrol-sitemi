...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Satın Alma Sipariş Detayları - <?php echo $po_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            ...
            <h4 class="text-info">Siparişler</h4>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin?page=purchase_order/manage_po&id='.(isset($id) ? $id : '') ?>">Düzenle</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=purchase_order' ?>">Listeye Geri Dön</a>
    </div>
</div>
