...
<div class="container-fluid">
	<form action="" id="item-form">
		...
		<div class="form-group">
			...
			<option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>İnaktif</option>
			</select>
		</div>
	</form>
</div>
<script>
	...
	$(document).ready(function(){
        $('.select2').select2({placeholder:"Lütfen Buradan Seçiniz",width:"relative"})
